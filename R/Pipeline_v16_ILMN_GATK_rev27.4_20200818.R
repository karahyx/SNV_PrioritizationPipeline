...
zMsDmg.mx[, 2] <- with (v_full_hq_r05.df, as.numeric (polyphen_score >= 0.90))
zMsDmg.mx[, 3] <- with (v_full_hq_r05.df, as.numeric (ma_score       >= 1.90))
zMsDmg.mx[, 4] <- with (v_full_hq_r05.df, as.numeric (phylopMam_avg >= 2.30))
zMsDmg.mx[, 5] <- with (v_full_hq_r05.df, as.numeric (phylopVert100_avg >= 4.0))
...
v_full_hq_r05.df$F_DamageTier[zMsDmg1.ix] <- 1
v_full_hq_r05.df$F_DamageTier[zMsDmg2.ix] <- 2
...
zUtrDmg2.ix <- with (v_full_hq_r05.df, which (
						...
						(phylopMam_avg >= 1.5 | CADD_phred >= 15) & 
...
zPhT1.ix <- with (v_full_hq_r05.df, which (entrez_id %in% g_phm0.eg))
zPhT2.ix <- with (v_full_hq_r05.df, which (entrez_id %in% g_phm1.eg))
...
v_full_hq_r05.df$F_CmpHet_S1 <- 0
...
v_full_hq_r05.df$FS1_XL_Pathg_Hap[z_x_hom.ix] <- 1
