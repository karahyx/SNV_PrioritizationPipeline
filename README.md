...
3 | Quality Filter | 3.1. Pass tag <br /> 3.2. Quality tag | 3.1. Add a pass tag that indicates whether the variant has a "PASS" FILTER <br /> 3.2. Add a quality tag that indicates whether variants with "PASS" FILTER pass the DP cutoff | 3.1. `F_Pass` = whether the variant has a "PASS" FILTER <br /> 3.2. `F_Qual_tag` = <br /> <ul> <li> "OK" if the variant has DP greater than or equal to 2 </li> <li> "LowQuality" otherwise </li> |
...
5 | Define Damage | 5.0. Variable Initialization <br /> 5.1. Coding LOF <br /> 5.2. Missense <br /> 5.3. Other Coding <br /> 5.4. Splicing Predictions <br /> 5.5. UTR <br /> 5.6. Non-coding | 5.0. Initialize columns `F_DamageType = "NotDmg"` , `F_DamageRank = 0`, and `F_S_DamageType = "NotDmg"` <br /> 5.1.-5.5. Add specific damaging type tags |  |
